...
Board.prototype.checkAdjacent = function (source, target) {
  ...
  let isAdjacent = diffCol + diffRow == 1;
...
Board.prototype.dropBlock = function (sourceRow, targetRow, col) {
  ...
  //TO DO dropBlock en game
  this.state.dropBlock(sourceRow, targetRow, col);
};

Board.prototype.dropReservedpBlock = function (sourceRow, targetRow, col) {
  this.grid[targetRow][col] = this.reserveGrid[sourceRow][col];
  this.reserveGrid[sourceRow][col] = 0;

  //TO DO dropReservedpBlock en game
  this.state.dropReservedpBlock(sourceRow, targetRow, col);
};
